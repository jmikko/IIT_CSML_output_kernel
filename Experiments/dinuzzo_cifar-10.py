...
for lam in list_of_lam:
    dinuzzo = DinuzzoOutputKernel(lam=lam, delta=delta, max_iterations=10000, verbose=0)
...
dinuzzo = DinuzzoOutputKernel(lam=optimal_lam, delta=delta, max_iterations=10000, verbose=1)
